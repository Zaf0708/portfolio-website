...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--brand-primary)] text-[var(--brand-white)] hover:bg-[#2F7FE0]",
        outline:
          "border border-[var(--brand-border)] bg-transparent hover:bg-transparent hover:text-[var(--brand-primary)]",
        secondary:
